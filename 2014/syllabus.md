...
### Design Studios
Held during lecture times, design studios are where you will hone your skills in designing visualizations using sketching and rapid, paper-based prototyping. Attendance for design studios is mandatory. The design studio consists of two parts. You first work individually on analyzing a dataset and create multiple sketches of visualizations to address the dataset. Then we will form groups of 4-5 students where you will discuss and evaluate your respective designs in the group. Online-only participants are encouraged to work in online-teams but are allowed to work individually. The design studios are synchronized with the homeworks and your final projects and are handed in together with these. 
